  ...
  const getData = async () => {
    ...
    try {
      const results = await Promise.allSettled([
        axios.get(URLS.GET_UPDATE_COURSES),
        axios.get(URLS.GET_UPDATE_CATEGORIES),
        axios.get(URLS.GET_UPDATE_BANNERS),
      ]);
      ...
      >
        ...
        >
          <div style={{...utils.rowCenter(), marginBottom: 4}}>
            <img
              src={'https://scontent.fdac27-2.fna.fbcdn.net/v/t39.30808-6/393205049_822400306557498_7309767441203305084_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=6ee11a&_nc_eui2=AeFAMrhEb1Hl0Chka-PsLTLZh5VYbrh45AKHlVhuuHjkAoThMW9102XTSCKjCU1KGZAu0AW793DwKX5f2329LB3s&_nc_ohc=zozPnjaCMk4Q7kNvwFkhv4w&_nc_oc=AdmPTj6LrgduenZlP1jBNJ01J7VlbxMKdx3NanBuxMeVF6nsvCXbB-VToSCzPi0Tm_Y&_nc_zt=23&_nc_ht=scontent.fdac27-2.fna&_nc_gid=UTzmnz3VmHynVTFWlpkcgQ&oh=00_AfM5ckhTzu0eqaNVEWRWh4ycR3zLgm77_4TA7MfET1VbBg&oe=68643941'}
              alt='logo'
              style={{
                width: 24,
                height: 24,
            ...
            />
            <text.H2 numberOfLines={1}>ইন্সপায়ার্ড আইটি</text.H2>
          </div>
          <text.T14
            style={{color: theme.colors.bodyTextColor, marginBottom: 12}}
          >
           যেখানে প্রযুক্তি, দক্ষতা ও কর্মসংস্থানের মিলন ঘটে
          </text.T14>
          <div
            style={{
              background:
    ...
    return (
      <div style={{marginBottom: 30}}>
        <components.BlockHeading
          ...
          containerStyle={{marginBottom: 7, padding: '0 20px'}}
        />
        {coursesData.slice(0, 6).map((course: any, index, array) => {
