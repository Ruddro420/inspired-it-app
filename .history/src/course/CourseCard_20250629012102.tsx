...
export const CourseCard: React.FC<Props> = ({
  ...
  if (section === 'my courses') {
    return (
      ...
      >
        <div
          style={{height: 96, position: 'relative',objectFit: 'cover',}}
          // onClick={() => navigate('/course-details', {state: {course}})}
        ...
        >
          ...
          /> */}
          <iframe width="auto" height="auto" src="https://www.youtube.com/embed/h4_Zx551bWU" title="How to Make Professional Money Receipt Design in Illustrator | Learn with Inspired IT" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
